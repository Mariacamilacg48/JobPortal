...
namespace JobPortal.Web.Controllers
{
    public class UserITMsController : Controller
    {
        ...
        {
            return View(await _context.UserITMs.ToListAsync());
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Document,FirstName,LastName,Semester,Carnet,CellPhone,Address")] UserITM userITM)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Document,FirstName,LastName,Semester,Carnet,CellPhone,Address")] UserITM userITM)
        {
            if (id != userITM.Id)
            {
                return NotFound();
